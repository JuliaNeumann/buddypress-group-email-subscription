...
function ass_default_subscription_settings_form() {
	...
	<div class="radio">
        <?php if ( displaySubscriptionOption('no') ) : ?>
        ...
        <?php if ( displaySubscriptionOption('sum') ) : ?>
        ...
        <?php if ( displaySubscriptionOption('dig') ) : ?>
        ...
        <?php if ( ass_get_forum_type() && displaySubscriptionOption('sub') ) : ?>
        ...
        <?php if ( displaySubscriptionOption('supersub') ) : ?>
